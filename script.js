...
emailInput.addEventListener("blur", () => {
  ...
  if (peserta) {
    ...
    kurikulumSelect.value = peserta.kurikulum;
    kelasSelect.value = peserta.kelas;
    ...
    kurikulumSelect.readOnly = true;
    kelasSelect.readOnly = true;
    ...
    kurikulumSelect.readOnly = false;
    kelasSelect.readOnly = false;
...
function loadMapelList(kelas) {
  const kurikulum = kurikulumSelect.value.trim();
  if (!kurikulum) {
...
["input", "blur"].forEach(evt => {
  kelasSelect.addEventListener(evt, () => {
